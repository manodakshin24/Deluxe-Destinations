...
const Footer = () => {
  return (
    <footer className='flexCenter pb-14 pt-20 bg-pattern bg-cover bg-center bg-no-repeat'>
      <div className='flex flex-col rounded-x1'>
            ...
            <div className='flex flex-col gap-5 '>
              <FooterColumn title={FOOTER_CONTACT_INFO.title}>
                  {FOOTER_CONTACT_INFO.links.map((link) => (
                      <Link href="/" key={link.label} className="flex gap-4 md:flex-bol lg:flex-row">
        ...
        <p className='regular-14 bg-secondary text-white py-2 px-8 rounded-b-xl flexBetween'><span>2024 Passport</span><span>All rights reserved.</span></p>
      </div>
    </footer>
  );
};
