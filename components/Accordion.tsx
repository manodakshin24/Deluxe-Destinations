"use client"
import { ACCORDION } from '@/constant/index'
...
const AccordionItem = ({open, toggle, question, answer}: AccordionItemProps) => {
  return (
    <div className='pt-3'>
      <div onClick={toggle} className={`px-3 py-4 medium-16 flex items-center gap-x-4 
      cursor-pointer ${open ? "bg-secondary text-white": ""}`}>
